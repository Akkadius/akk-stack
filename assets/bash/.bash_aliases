...
alias cm='source && cmake -DEQEMU_BUILD_LOGIN=ON -DEQEMU_BUILD_LUA=ON -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_CXX_FLAGS_RELWITHDEBINFO:STRING="-O1 -g -DNDEBUG" -G -DCURL_LIBRARY=~/code/dependencies/curl_x64/lib -DCURL_INCLUDE_DIR=~/code/dependencies/curl_x64/include "Unix Makefiles" ..'
alias k='pkill zone'
alias r='m && z &'
